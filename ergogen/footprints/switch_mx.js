...
module.exports = {
  params: {
    ...
    from: undefined,
    to: undefined,
    stabilizer_1_net: {type: 'net', value: 'VCC'},
    stabilizer_2_net: {type: 'net', value: 'GND'}
  },
  body: p => {
    const stab_holes_plated = p.plated_stabilizer_holes ? 'thru_hole' : 'np_thru_hole'
    const common_top = `
  (footprint "ceoloide:switch_mx"
    ...
    (pad "" ${stab_holes_plated} circle (at 5.08 0 180) (size ${p.stabilizers_diameter} ${p.stabilizers_diameter}) (drill ${p.stabilizers_diameter}) (layers "*.Cu" "*.Mask") ${p.plated_stabilizer_holes ? p.stabilizer_1_net : ''})
    (pad "" ${stab_holes_plated} circle (at -5.08 0 180) (size ${p.stabilizers_diameter} ${p.stabilizers_diameter}) (drill ${p.stabilizers_diameter}) (layers "*.Cu" "*.Mask") ${p.plated_stabilizer_holes ? p.stabilizer_2_net : ''})
    `
    const corner_marks = `
