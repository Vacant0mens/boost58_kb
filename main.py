...
keyboard.keymap = [
    [  # 0 - Qwerty
        ...
        KC.xxxxxxxxxx, KC.LALT,       KC.LCTL,       KC.MO(2),      KC.SPC,        KC.MO(1),      KC.MO(1),      KC.SPC,        KC.LALT,       KC.LGUI,       KC.TG(2),      KC.xxxxxxxxxx
    ],
    [  # 1 - Nav, Symbols
        KC.ESC,        KC.LCTL(KC.U), KC.F9,         KC.F10,        KC.F11,        KC.F12,        KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.LCBR,       KC.RCBR,       KC.DEL,
        KC.F8,         KC.LCTL(SPC),  KC.CTL_F5,     KC.F5,         KC.F2,         KC.F1,         KC.TAB,        KC.HOME,       KC.UP,         KC.END,        KC.LBRC,       KC.RBRC,
        KC.PSCR,       KC.COPY,       KC.SAVE,       KC.LCTL(KC.N), KC.LCTL(KC.F), KC.UNDO,       KC.BSLS,       KC.LEFT,       KC.DOWN,       KC.RGHT,       KC.SCLN,       KC.QUOT,
        KC.CUT,        KC.PSTE,       KC.SEL_ALL,    KC.CTL_SHFT_N, KC.LCTL(KC.H), KC.REDO,       KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.LABK,       KC.RABK,       KC.MINUS,
        KC.xxxxxxxxxx, KC.PLAYPAUSE,  KC.LGUI(KC.I), KC.LGUI(KC.L), KC.LSFT,       KC.TRNS,       KC.TRNS,       KC.SPC,        KC.COMMENT,    KC.AUTOFMT,    KC.MUTE,       KC.xxxxxxxxxx
    ],
    [  # 2 - Media, HotKeys (Pwsh, VSCode), NumPad/10-key
        KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.LPRN,       KC.RPRN,       KC.DEL,
        KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.N7,         KC.N8,         KC.N9,         KC.MINUS,      KC.PLUS,
        KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.N4,         KC.N5,         KC.N6,         KC.UNDS,       KC.EQUAL,
        KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.N1,         KC.N2,         KC.N3,         KC.NOT_SET,    KC.ENT,
        KC.xxxxxxxxxx, KC.NOT_SET,    KC.NOT_SET,    KC.NOT_SET,    KC.TRNS,       KC.NOT_SET,    KC.NOT_SET,    KC.SPC,        KC.N0,         KC.DOT,        KC.TG(2),      KC.xxxxxxxxxx
    ]
]
